...
``url`` in the add-on's manifest; for this copy that is
https://github.com/joshknnd1982/classicspeech-nvda. A check asks GitHub for the
latest release and compares its tag, such as v1.08, with the installed version.
